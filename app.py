...
from sqlalchemy import ForeignKey, Table, Column, String, DateTime, select
...
#     db.session.commit(new_product) #returns new product to the database
...
#         return jsonify(e.messages), 400
#     new_order = Order(order_date=order_data['order_date'], user_id=order_data['user_id']) #Creates a new order object with the validated data.
...
#         return jsonify(f"{product.product_name}")
#=====================================================================================================================================================
